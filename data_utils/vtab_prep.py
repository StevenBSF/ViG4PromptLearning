...
data_dir = "/data/ckpt/baoshifeng/vig_pytorch/data/VTAB/"  # TODO: setup the data_dir to put the the data to, the DATA.DATAPATH value in config

# download_config = download.DownloadConfig()
# download_config.download_mode = 'reuse_dataset_if_exists'

# # caltech101
# dataset_builder = tfds.builder("caltech101:3.0.0", data_dir=data_dir)
# dataset_builder.download_and_prepare()
# # dataset_builder, n = tfds.load("caltech101:3.0.1", data_dir="/data-x/g12/huangqidong/VTAB/")

# cifar100
dataset_builder = tfds.builder("cifar100:3.0.0", data_dir=data_dir)
dataset_builder.download_and_prepare()
